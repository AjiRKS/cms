...
$edit = mysqli_query($connection, "SELECT * FROM berita WHERE id_berita='$_GET[id]'");
...
$tampil = mysqli_query($connection, "SELECT * FROM kategori ORDER BY nama_kategori");
...
<tr>
    <td>Isi Berita</td>
    <td> : <textarea name='isi_berita' cols='80' rows='18'>$r[isi_berita]</textarea></td>
</tr>
<tr>
    <td>Gambar</td>
    <td> : <img src='../images/foto_berita/$r[gambar]'></td>
</tr>
<tr>
    <td>Ganti Gambar</td>
